    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
      ...
      <div class="space-y-6">
        ...
        <div class="space-y-3 text-sm text-gray-600 leading-relaxed">
          <p>
            {{ t('flap.step2.color.description.beforeProduct') }}
            <strong>{{ t('flap.step2.color.description.product') }}</strong>
            {{ t('flap.step2.color.description.middle') }}
            <strong>{{ t('flap.step2.color.description.ralColors') }}</strong>.
          </p>
